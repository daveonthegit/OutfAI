...
const benefits = [
  {
    title: "Decide faster",
    copy: "Move from closet to outfit with less morning friction.",
  },
  {
    title: "Wear more of what you own",
    copy: "Bring good pieces back into rotation instead of reaching for the same default look.",
  },
  {
    title: "Repeat with intention",
    copy: "Save combinations that work and reuse them when the day calls for it.",
  },
  {
    title: "Shop less randomly",
    copy: "See what your wardrobe is actually missing before adding more noise.",
  },
];
...
const faqItems = [
  {
    question: "Do I need to upload my whole closet?",
    answer:
      "No. Start with a few pieces you wear often, then add more whenever you want better recommendations.",
  },
  {
    question: "Does OutfAI only suggest clothes to buy?",
    answer:
      "No. OutfAI starts with styling what you already own. Shopping only makes sense after your closet has context.",
  },
  {
    question: "Can I save outfits?",
    answer:
      "Yes. Saved looks help you repeat, refine, and schedule combinations without rebuilding the same idea every time.",
  },
  {
    question: "Is this for one specific style?",
    answer:
      "No. The suggestions adapt around your wardrobe, whether your style is minimal, polished, expressive, casual, or capsule-based.",
  },
];
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-background text-foreground dark:bg-[var(--marketing-void)] dark:text-[#f4f3ef]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[min(96rem,96vw)] px-3 py-2 sm:px-5 sm:py-3 md:px-8">
        ...
        <section className="grid gap-5 border-t border-[#0a0a0a]/10 py-12 dark:border-[#f4f3ef]/12 lg:grid-cols-[0.72fr_1.28fr] lg:py-16">
          <div>
            <p className="font-sans text-[10px] uppercase tracking-[0.32em] text-[#6a6258] dark:text-[#b7ada0]">
              Why OutfAI
            </p>
            ...
            <p className="mt-6 max-w-[36rem] text-pretty font-sans text-base leading-relaxed text-[#3f3932] dark:text-[#d8d1c4]">
              The point is not more options. It is better direction from the
              pieces, plans, and preferences you already have.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {benefits.map((benefit) => (
              <article
                ...
                className="rounded-[var(--marketing-radius-apple)] border border-[#0a0a0a]/10 bg-[#f5f5f7]/68 p-5 dark:border-[#f4f3ef]/12 dark:bg-[#111111]/68"
              >
                <h3 className="font-serif text-2xl italic leading-none">
                  {benefit.title}
                </h3>
                <p className="mt-4 text-pretty font-sans text-sm leading-relaxed text-[#3f3932] dark:text-[#d8d1c4]">
                  {benefit.copy}
        ...
        <section className="grid gap-5 border-t border-[#0a0a0a]/10 py-12 dark:border-[#f4f3ef]/12 lg:grid-cols-[0.72fr_1.28fr] lg:py-16">
          ...
          <div className="grid content-start gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {useCases.map((useCase) => (
              <div
                key={useCase}
                className="rounded-[var(--marketing-radius-apple)] border border-[#0a0a0a]/10 bg-[#f5f5f7]/68 px-4 py-4 font-sans text-[10px] uppercase tracking-[0.2em] text-[#4b4740] dark:border-[#f4f3ef]/12 dark:bg-[#111111]/68 dark:text-[#cfc7ba]"
              >
                {useCase}
              </div>
            ))}
          ...
          <div className="grid gap-3">
            {faqItems.map((item) => (
              <article
                ...
                className="rounded-[var(--marketing-radius-apple)] border border-[#0a0a0a]/10 bg-[#f5f5f7]/68 p-5 dark:border-[#f4f3ef]/12 dark:bg-[#111111]/68"
              >
                <h3 className="font-sans text-xs font-semibold uppercase tracking-[0.18em] text-[#0a0a0a] dark:text-[#f4f3ef]">
                  {item.question}
                </h3>
                <p className="mt-3 text-pretty font-sans text-sm leading-relaxed text-[#3f3932] dark:text-[#d8d1c4]">
                  {item.answer}
                </p>
              </article>
            ))}
