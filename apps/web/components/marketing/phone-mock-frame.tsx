...
export function PhoneMockFrame({
  ...
  return (
    <section
      className={cn(
        "relative mx-auto w-full max-w-[min(100%,400px)] px-1 sm:max-w-[min(100%,420px)] lg:max-w-[min(100%,440px)]",
        className
      )}
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          className={cn(
            "relative rounded-[3rem] bg-gradient-to-b from-[#4a4a4a] via-[#2e2e2e] to-[#161616] p-[12px] shadow-[0_2px_0_rgba(255,255,255,0.06)_inset,0_-1px_0_rgba(0,0,0,0.45)_inset,0_48px_96px_-32px_rgba(0,0,0,0.55),0_16px_40px_-12px_rgba(0,0,0,0.35)] ring-1 ring-black/50",
        ...
        >
          {/* Inner bezel lip */}
          <div className="rounded-[2.4rem] bg-gradient-to-b from-[#0a0a0a] to-[#050505] p-[2px] shadow-[0_1px_0_rgba(255,255,255,0.04)]">
            <div className="relative flex min-h-0 flex-col overflow-hidden rounded-[2.25rem] bg-[#010101] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04)]">
