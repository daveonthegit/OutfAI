...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(
        brutalistButtonVariants({ variant: "solid", size: "md" }),
        className
      )}
      {...props}
    />
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(
        brutalistButtonVariants({ variant: "outline", size: "md" }),
        className
      )}
      {...props}
    />
