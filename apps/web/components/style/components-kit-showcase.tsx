...
/** Interactive component gallery merged from the former `/kit` route into `/style`. */
export function ComponentsKitShowcase() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border">
        <div className="max-w-5xl mx-auto flex items-center justify-between px-4 py-5 md:px-8 lg:px-10 xl:px-12">
          <div className="flex items-center justify-between w-full gap-4">
            <div>
              ...
              <h1 className="text-2xl font-serif italic mt-1">Components</h1>
              <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-1">
                Interactive gallery (also linked from Design System →
                Components)
              </p>
            </div>
            <div className="flex items-center gap-2 shrink-0">
              <div className="w-2 h-2 bg-acid-lime" aria-hidden />
