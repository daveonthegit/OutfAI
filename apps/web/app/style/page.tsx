...
import { ComponentsKitShowcase } from "@/components/style/components-kit-showcase";
...
export default function StyleDocPage() {
  ...
  const [docSurface, setDocSurface] = useState<"reference" | "components">(
    "reference"
  );
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-bar rounded-none border-x-0 border-t-0 border-b border-border">
        <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-5 md:px-8 lg:px-10 xl:px-12">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div
              ...
              role="tablist"
              aria-label="Design system surface"
            >
              <button
                type="button"
                role="tab"
                aria-selected={docSurface === "reference"}
                onClick={() => setDocSurface("reference")}
                className={`px-3 py-1.5 text-[9px] uppercase tracking-[0.2em] transition-colors duration-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal-orange focus-visible:ring-offset-2 ${
                  docSurface === "reference"
              ...
              <button
                type="button"
                role="tab"
                aria-selected={docSurface === "components"}
                onClick={() => setDocSurface("components")}
                className={`px-3 py-1.5 text-[9px] uppercase tracking-[0.2em] transition-colors duration-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal-orange focus-visible:ring-offset-2 ${
                  docSurface === "components"
                    ? "bg-foreground text-background"
                    : "text-muted-foreground hover:text-foreground"
                }`}
              >
              ...
              <SubSection title="Usage Rule">
                <div className="bg-secondary border border-border p-6">
                  <p className="text-xs text-foreground leading-relaxed">
                    ...
                    Orange is the primary accent and should be used for the
                    single most important action or highlight. Acid Lime is
                    reserved for status/toggles. Electric Blue is rare. Chrome
                    Silver is for metadata only.
                  </p>
                </div>
              </SubSection>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed mb-6">
                      Used for headlines, mood text, and editorial moments.
                      Italic at all display sizes for maximum editorial contrast
                      against the sharp UI elements. Never used for body text.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed mb-6">
                      Used for all UI elements, labels, navigation, and body
                      text. Uppercase with wide letter-spacing for labels.
              ...
              <SubSection title="Bottom Nav">
                <div className="bg-secondary border border-border p-6">
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    ...
                    every screen. It contains 5 primary destinations (Today,
