...
| **Onboarding**                | Implemented: multi-step wizard, redirect guard, skip (issues #8, #9).                                                                                      | —                                                      |
| **Profile/settings**          | Implemented: editable profile, avatar, preferences, change password/email, delete account, data export (issues #1–#5, #7, #10). Sessions/2FA backlog (#6). | —                                                      |
| **User preferences UI**       | Implemented: favorite moods, preferred/avoided styles and colors, style goal (issue #7).                                                                   | —                                                      |
| **Closet search**             | Implemented: debounced search by name (issue #18).                                                                                                         | —                                                      |
| **Data export**               | Implemented: "Download my data" in Settings (issue #10).                                                                                                   | —                                                      |
...
| Gap                             | Description                                                                                                                         | Impact                                               |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| **No learning from feedback**   | Recommendation logs are wired (shown/saved/skipped/worn). Learning pipeline not yet built (issue #27).                              | Engine stays rule-based until Phase 4.               |
